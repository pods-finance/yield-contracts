...
contract BaseVault is IVault {
     ...
     */
    function sharesOf(address owner)
        public
        view
        returns (uint256 unlocked, uint256 locked)
    {
     ...
     */
    function previewShares(uint256 underlyingAmount)
        public
        view
        returns (uint256)
    {
    ...
    function closeRound(uint256 amountYielded) public onlyStrategist {
     ...
     */
    function _mintLockedShares(address owner, uint256 shareAmount) private {
